...
export default function Timer({ durationInit, durationLong, durationShort, maxTimeElapsed }: 
    { durationInit: number, durationLong: number, durationShort: number, maxTimeElapsed: number }) {
